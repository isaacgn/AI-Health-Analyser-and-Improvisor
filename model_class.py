...
class DiabetesCheck(FlaskForm):
	pregnancies = StringField("Pregnancies")
	glucose = StringField("Glucose")
	pregnancies = StringField("BloodPressure")
	glucose = StringField("SkinThickness")
	pregnancies = StringField("Insulin")
	bmi = StringField("BMI")
...
class CancerCheck(FlaskForm):
	...
	concave_points_mean = StringField("concave points_mean")
	...
	concave_points_se = StringField("concave points_se")

	smoothness_se = StringField("symmetry_se")
	fractal_dimension_se = StringField("fractal_dimension_se")

	radius_worst = StringField("radius_worst")
	texture_worst = StringField("texture_worst")

	parameter_worst = StringField("perimeter_worst")
	...
	concave_points_worst = StringField("concave points_worst")
